  ...
  return (
    <div>
      ...
      <div className="relative">
        <div className="w-full md:h-96 lg:h-[450px]">
          <img
      ...
      {/* profile end */}
      <div className="grid lg:grid-cols-9 mt-40">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mb-5">
            <div className="flex gap-2">
              ...
              <textarea
                ...
                className="w-full h-40 mt-2 p-3 rounded-xl border border-black"
                {...register("caption")}
              ></textarea>
            </div>
            <div className="flex items-center justify-between mt-3">
              <input
                ...
                {...register("image_file")}
              />
              <button className="bg-black text-white py-2.5 px-8 font-bold rounded-md">
                {loading ? (
